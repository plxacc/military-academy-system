...
app.get('/dashboard', async (req, res) => {
    ...
    const trainersList = [
    { name: "مالك البتار", role: "مدرب الكلية", duty: "مدرب التفاوض" },
    { name: "ايدا مارتينيز", role: "مدرب الكلية", duty: "مدربة استيقافات" },
    { name: "غوار المغوار", role: "مدرب الكلية", duty: "مدرب استيقافات" },
    { name: "ضرغام حلتاوي", role: "مدرب الكلية", duty: "مدرب عمليات" },
    { name: "امين العبادي", role: "مدرب الكلية", duty: "مدرب عمليات" }
];
